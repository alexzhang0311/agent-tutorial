...
SIMPLE_RESEARCH_INSTRUCTIONS = """IMPORTANT: You must write content to a file in the virtual filesystem to retain and save context and use the result provided by the tool to answer the user's question."""